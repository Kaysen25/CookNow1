package com.example.mycooknow.Activity.adapter;
...
import com.example.mycooknow.Activity.activity.Fullview;
...
public class CustomAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final String targeeb=constantList.get(i).getTargeeb();
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("targeeb", targeeb);
